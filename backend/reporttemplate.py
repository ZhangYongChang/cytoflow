...
<body style="margin:0;">
	<table cellspacing="0" cellpadding="0" border="0" style="border-width:0px;width:718px;border-collapse:collapse;">
		<tr style="height:21px;">
			<td class="se7a0660f" colspan="26" style="height:21px;width:416px;line-height:0;"><img
					src="1.Jpeg"
					style="height:21px;width:416px;border-width:0px;" /></td>
			<td class="s43c794a1" colspan="21" style="max-height:21px;height:21px;width:302px;max-width:302px;">武汉康圣达医学检验所
			</td>
		</tr>
		<tr style="height:2px;">
			<td class="se7a0660f" colspan="46" style="height:2px;width:711px;line-height:0;"><img
					src="2.Jpeg"
					style="height:2px;width:711px;border-width:0px;" /></td>
			<td style="border:0px;height:2px;width:7px;"></td>
		</tr>
		<tr style="height:7px;">
			<td class="se7a0660f" colspan="27" rowspan="4" style="height:33px;width:438px;line-height:0;"><img
					src="3.Jpeg"
					style="height:33px;width:438px;border-width:0px;" /></td>
			<td class="scaa3a684" colspan="20" rowspan="2" style="max-height:15px;height:15px;width:280px;max-width:280px;">
				武汉高新大道666号光谷生物城D2-1</td>
		</tr>
		<tr style="height:8px;">

		</tr>
		<tr style="height:3px;">
			<td class="scaa3a684" colspan="20" rowspan="2" style="max-height:18px;height:18px;width:280px;max-width:280px;">
		...
		<tr style="height:4px;">
			<td class="se7a0660f" colspan="46" style="height:4px;width:711px;line-height:0;"><img
					src="4.Jpeg"
					style="height:4px;width:711px;border-width:0px;" /></td>
			<td style="border:0px;height:4px;width:7px;"></td>
		</tr>
		<tr style="height:38px;">
			<td class="s0ac82ed1" colspan="47" style="max-height:38px;height:38px;width:718px;max-width:718px;">血液肿瘤免疫分型报告单
			</td>
		</tr>
		<tr style="height:22px;">
			<td class="sa5f9e952" colspan="47" style="max-height:22px;height:22px;width:718px;max-width:718px;">Hematological
				Tumor Immunotype Report</td>
		</tr>
		<tr style="height:8px;">
		...
		<tr style="height:32px;">
			...
			<td class="sa6be309e" colspan="6" style="max-height:31px;height:31px;width:90px;max-width:90px;">&nbsp;姓名(Name)：
			</td>
			<td class="s071be6ee" colspan="8" style="height:31px;width:112px;">{{specimen.name}}</td>
			<td class="sa6be309e" colspan="5" style="max-height:31px;height:31px;width:82px;max-width:82px;">&nbsp;性别(Sex)：
			</td>
			<td class="sb60498d5" colspan="3" style="height:31px;width:52px;">{{specimen.sex}}</td>
			<td class="sa6be309e" colspan="3" style="max-height:31px;height:31px;width:82px;max-width:82px;">&nbsp;年龄(Age)：
			</td>
			<td class="sb60498d5" colspan="4" style="height:31px;width:60px;">{{specimen.age}}岁</td>
			<td class="sa6be309e" colspan="7" style="max-height:31px;height:31px;width:105px;max-width:105px;">
				&nbsp;标本编号(No.)：</td>
			<td class="sb60498d5" colspan="7" style="max-height:31px;height:31px;width:97px;max-width:97px;">{{specimen.specimenno}}</td>
		...
		<tr style="height:30px;">
			<td style="border:0px;height:30px;width:8px;"></td>
			<td class="s7afdc30c" style="height:30px;width:7px;"></td>
			<td class="sa6be309e" colspan="8" style="max-height:29px;height:29px;width:113px;max-width:113px;">&nbsp;床号(Bed
				No.)：</td>
			<td class="sb60498d5" colspan="14" style="height:29px;width:225px;">9</td>
			<td class="sa6be309e" colspan="4" style="max-height:29px;height:29px;width:120px;max-width:120px;">
				&nbsp;送检医生(Dr.)：</td>
			<td class="sb60498d5" colspan="17" style="height:29px;width:226px;">申琴</td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
			<td style="border:0px;height:30px;width:7px;"></td>
		</tr>
		<tr style="height:2px;">
		...
		<tr style="height:24px;">
			...
			<td class="sa6be309e" colspan="17" style="max-height:23px;height:23px;width:241px;max-width:241px;">
				&nbsp;采集时间(Specimen Sampling Time)：</td>
			<td class="sb60498d5" colspan="5" style="max-height:23px;height:23px;width:97px;max-width:97px;">2019-10-10</td>
			<td class="sa6be309e" colspan="13" style="max-height:23px;height:23px;width:241px;max-width:241px;">
				&nbsp;接收时间(Specimen Receive Time)：</td>
			<td class="sb60498d5" colspan="8" style="max-height:23px;height:23px;width:105px;max-width:105px;">2019-10-12</td>
		...
		<tr style="height:22px;">
			...
			<td class="s3d6c5dc2" colspan="43"
				style="max-height:22px;height:22px;white-space:pre-wrap;max-width:688px;width:688px;"> 获取和分析细胞数(Total
				Events)：20000 CD45/SSC 设门 (CD45/SSC Gates)</td>
		...
		<tr style="height:23px;">
			...
			<td class="s7afdc30c" style="height:23px;width:7px;"></td>
			<td class="s3d6c5dc2" colspan="43"
				style="max-height:23px;height:23px;white-space:pre-wrap;max-width:688px;width:688px;"> 各群细胞占有核细胞比例(Cell
				Population Proportion)：</td>
			<td class="se62e4896" style="height:23px;width:8px;"></td>
			<td style="border:0px;height:23px;width:7px;"></td>
		</tr>
		<tr style="height:7px;">
		...
		<tr style="height:30px;">
			...
			<td class="s7b0a07d2" colspan="6" style="height:29px;width:90px;">39%</td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
		...
		<tr style="height:31px;">
			...
			<td class="s7b0a07d2" colspan="6" style="height:30px;width:90px;">1%</td>
		...
		<tr style="height:30px;">
			...
			<td class="s7b0a07d2" colspan="6" style="height:29px;width:90px;">57%</td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
			<td class="sc8e3ace7" colspan="5" style="height:30px;width:60px;"></td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
			<td style="border:0px;height:30px;width:7px;"></td>
		...
		<tr style="height:30px;">
			...
			<td class="s7b0a07d2" colspan="6" style="height:29px;width:90px;">3%</td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
			<td class="sc8e3ace7" colspan="5" style="height:30px;width:60px;"></td>
			<td class="se62e4896" style="height:30px;width:8px;"></td>
			<td style="border:0px;height:30px;width:7px;"></td>
		...
		<tr style="height:108px;">
			...
			<td class="s0dd5de56" colspan="40" style="max-height:108px;height:108px;width:665px;max-width:665px;">
				<br>印象：在CD45/SSC点图上设门分析，原始向髓系延伸的分布区域可见异常细胞群体，约占有核细胞的57%，主要表达HLA-DR、CD4、CD15、CD33、CD38、CD56、CD58、CD123。<br><br><br>提示：异常髓系增殖，AML可能。请结合临床及其他相关检查结果综合判断。<br>
			</td>
		...
		<tr style="height:23px;">
			...
			<td style="border:0px;height:23px;width:38px;"></td>
			<td class="sd051d7c6" colspan="7" rowspan="3" style="height:53px;width:129px;line-height:0;"><img
					src="5.Jpeg"
					style="height:53px;width:129px;border-width:0px;" /></td>
			<td style="border:0px;height:23px;width:22px;"></td>
			<td style="border:0px;height:23px;width:23px;"></td>
			<td style="border:0px;height:23px;width:7px;"></td>
			<td style="border:0px;height:23px;width:8px;"></td>
		...
		<tr style="height:7px;">
			...
			<td style="border:0px;height:7px;width:7px;"></td>
			<td class="se7a0660f" colspan="6" rowspan="2" style="height:30px;width:99px;line-height:0;"><img
					src="6.Jpeg"
					style="height:30px;width:99px;border-width:0px;" /></td>
			<td style="border:0px;height:7px;width:7px;"></td>
			<td style="border:0px;height:7px;width:15px;"></td>
			<td style="border:0px;height:7px;width:15px;"></td>
			<td style="border:0px;height:7px;width:8px;"></td>
		...
		<tr style="height:22px;">
			...
			<td style="border:0px;height:22px;width:38px;"></td>
			<td class="sd051d7c6" colspan="5" style="height:22px;width:98px;line-height:0;"><img
					src="7.Jpeg"
					style="height:22px;width:98px;border-width:0px;" /></td>
		...
		<tr style="height:46px;">
			<td style="border:0px;height:46px;width:8px;"></td>
			<td class="sd051d7c6" colspan="16" style="height:46px;width:226px;line-height:0;"><img
					src="8.Jpeg"
					style="height:46px;width:226px;border-width:0px;" /></td>
		...
		<tr style="height:1px;">
			<td class="se7a0660f" colspan="46" style="height:1px;width:711px;line-height:0;"><img
					src="9.Jpeg"
					style="height:1px;width:711px;border-width:0px;" /></td>
			<td style="border:0px;height:1px;width:7px;"></td>
		</tr>
		<tr style="height:8px;">
			<td class="se7a0660f" colspan="27" rowspan="4" style="height:34px;width:438px;line-height:0;"><img
					src="10.Jpeg"
					style="height:34px;width:438px;border-width:0px;" /></td>
			<td class="scaa3a684" colspan="20" rowspan="2" style="max-height:15px;height:15px;width:280px;max-width:280px;">
				武汉高新大道666号光谷生物城D2-1</td>
		</tr>
		<tr style="height:7px;">
		...
		<tr style="height:4px;">
			<td class="scaa3a684" colspan="20" rowspan="2" style="max-height:19px;height:19px;width:280px;max-width:280px;">
				400-736-1666 800-810-0579</td>
		</tr>
		<tr style="height:15px;">
		...
		<tr style="height:847px;">
			<td class="se7a0660f" colspan="47" style="height:847px;width:718px;line-height:0;"><img
					src="scatter1.Jpeg"
					style="height:847px;width:718px;border-width:0px;" /></td>
		</tr>
		...
		<tr style="height:3px;">
			<td class="se7a0660f" colspan="46" style="height:3px;width:711px;line-height:0;"><img
					src="13.Jpeg"
					style="height:3px;width:711px;border-width:0px;" /></td>
			<td style="border:0px;height:3px;width:7px;"></td>
		</tr>
		<tr style="height:847px;">
			<td class="se7a0660f" colspan="47" style="height:847px;width:718px;line-height:0;"><img
		...
		<tr style="height:72px;">
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:15px;"></td>
			<td style="border:0px;height:72px;width:4px;"></td>
			<td style="border:0px;height:72px;width:19px;"></td>
			<td style="border:0px;height:72px;width:15px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:30px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:16px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:23px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:38px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:15px;"></td>
			<td style="border:0px;height:72px;width:15px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:37px;"></td>
			<td style="border:0px;height:72px;width:23px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:22px;"></td>
			<td style="border:0px;height:72px;width:38px;"></td>
			<td style="border:0px;height:72px;width:23px;"></td>
			<td style="border:0px;height:72px;width:22px;"></td>
			<td style="border:0px;height:72px;width:38px;"></td>
			...
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:34px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
			<td style="border:0px;height:72px;width:4px;"></td>
			<td style="border:0px;height:72px;width:8px;"></td>
			<td style="border:0px;height:72px;width:7px;"></td>
		...
		<tr style="height:14px;">
			...
			<td style="border:0px;height:14px;width:8px;"></td>
			<td style="border:0px;height:14px;width:8px;"></td>
			<td class="s99e83711" colspan="5" rowspan="2" style="height:15px;width:60px;">3/3</td>
		</tr>
		<tr style="height:1px;">
			<td style="border:0px;height:1px;width:8px;"></td>
			<td style="border:0px;height:1px;width:7px;"></td>
