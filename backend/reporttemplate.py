...
<body style="margin:3;">
  <table cellspacing="0" cellpadding="0" border="0" style="border-width:0px;width:718px;border-collapse:collapse;">
    ...
    <!--Page3-->
    <tr style="height:21px;">
      <td class="pdfTopImg" colspan="26" style="height:21px;width:416px;line-height:0;"><img
          src="1.Jpeg"
          style="height:21px;width:416px;border-width:0px;" /></td>
      <td class="pdfCompanyName" colspan="21" style="max-height:21px;height:21px;width:302px;max-width:302px;">武汉康圣达医学检验所
      </td>
    </tr>
    <tr style="height:2px;">
      <td class="pdfTopImg" colspan="46" style="height:2px;width:711px;line-height:0;"><img
          src="2.Jpeg"
          style="height:2px;width:711px;border-width:0px;" /></td>
      <td style="border:0px;height:2px;width:7px;"></td>
    </tr>
    <tr style="height:7px;">
      <td class="pdfTopImg" colspan="27" rowspan="4" style="height:34px;width:438px;line-height:0;"><img
          src="12.Jpeg"
    ...
    <tr style="height:3px;">
      <td class="pdfTopImg" colspan="46" style="height:3px;width:711px;line-height:0;">
        <img src="13.Jpeg" style="height:3px;width:711px;border-width:0px;" />
      </td>
      <td style="border:0px;height:3px;width:7px;"></td>
    </tr>
    <tr style="height:847px;">
      <td class="pdfTopImg" colspan="47" style="height:847px;width:718px;line-height:0;">
        {{matplotimg.img2}}
        <!--<img src="scatter1.Jpeg" style="height:847px;width:718px;border-width:0px;" />-->
      </td>
    </tr>
